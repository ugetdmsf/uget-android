...
public class FileItem extends LinearLayout {
	...
	private void updateIcon() {
		// Define the icon.
		int icon = R.mipmap.document;
		if(this.file != null && file.isDirectory()) {
			icon = this.selectable? R.mipmap.folder : R.mipmap.folder_gray;
		} else {
			icon = this.selectable? R.mipmap.document : R.mipmap.document_gray;
		}
		...
		if(icon != R.mipmap.document_gray && icon != R.mipmap.folder_gray) {
