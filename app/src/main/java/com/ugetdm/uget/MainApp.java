...
//        unbindService(timerServiceConnection);
    ...
    public void startRunning() {
        ...
        // create/initialize adapter and RPC server
        logAppend ("App.startRunning() create Adapter and RPC server");
        categoryAdapter = new CategoryAdapter(this, core.nodeReal, core.nodeMix);
        downloadAdapter = new DownloadAdapter(this, Node.getNthChild(core.nodeMix, 0));
...
//          clipboard.setPrimaryClip(ClipData.newRawUri("URI", Uri.parse("")));
    ...
    public void notifyMessage(int titleId, int contentId, int flags) {
        ...
        if (android.os.Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP)
            ...
            builder.setSmallIcon(R.mipmap.ic_notification).setColor(Color.GREEN - 0x6600);  // 0xff00ff00 - 0x6600
